...
LEARNING_RATE = 5e-5 # can try 5e-5, 3e-5, or 2e-5
...
def train(dataloader, model, num_epochs, log_interval):
    model.train()
...
for epoch in range(NUM_EPOCHS):
    ...
    train(train_loader, model=model, num_epochs=NUM_EPOCHS, log_interval=1)
